...
declare type ChimeKind = 'chime' | 'chime_pro' | 'chime_v2' | 'chime_pro_v2';
...
declare type HealthCategory = 'very_poor' | 'poor' | 'good' | 'very_good' | 'unknown' | 'NA' | string | null;
...
export declare type TwoStageVerificationState = 'sms' | 'email' | 'totp';
export declare type Auth2faResponse = {
